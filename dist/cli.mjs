...
var zhHansTranslation = {
	...
	"THINKING...": "思考中...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "请通过 `ai config set AI_API_KEY=<your token>` 设置您的 AI API 密钥",
	"Set config": "设置配置",
	"Enter your AI API key": "输入您的 AI API 密钥",
	"(not set)": "(未设置)",
	"AI API Key": "AI API 密钥",
	"Please enter a key": "请输入密钥",
	"AI API Endpoint": "AI API 端点",
	"Enter your AI API Endpoint": "输入您的 AI API 端点",
	"Silent Mode": "静默模式",
...
var zhHantTranslation = {
	...
	"THINKING...": "思考中...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "請通過 `ai config set AI_API_KEY=<your token>` 設置您的 AI API 密鑰",
	"Set config": "設置配置",
	"Enter your AI API key": "輸入您的 AI API 密鑰",
	"(not set)": "（未設置）",
	"AI API Key": "AI API 密鑰",
	"Please enter a key": "請輸入密鑰",
	"AI API Endpoint": "AI API 端點",
	"Enter your AI API Endpoint": "輸入您的 AI API 端點",
	"Silent Mode": "靜默模式",
	...
	You: You$b,
	"AI Provider": "AI 提供商",
	"Select your AI Provider": "選擇您的 AI 提供商"
};
...
var esTranslation = {
	...
	"THINKING...": "PENSANDO...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "Por favor configure su clave de API de AI a través de `ai config set AI_API_KEY=<your token>`",
	"Set config": "Configuración",
	"Enter your AI API key": "Ingrese su clave de API de AI",
	"(not set)": "(no establecido)",
	"AI API Key": "Clave de API de AI",
	"Please enter a key": "Por favor ingrese una clave",
	"AI API Endpoint": "Punto final de la API de AI",
	"Enter your AI API Endpoint": "Ingrese su punto final de API de AI",
	...
	"Select your AI Provider": "Seleccione su proveedor de AI"
};
...
var jpTranslation = {
	...
	"THINKING...": "考え中...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "AI APIキーを `ai config set AI_API_KEY=<your token>` で設定してください",
	"Set config": "設定",
	"Enter your AI API key": "AI APIキーを入力してください",
	"(not set)": "(未設定)",
	"AI API Key": "AI APIキー",
	"Please enter a key": "キーを入力してください",
	"AI API Endpoint": "AI APIエンドポイント",
	"Enter your AI API Endpoint": "AI APIエンドポイントを入力してください",
	...
	"Select your AI Provider": "AIプロバイダーを選択してください"
};
...
var koTranslation = {
	...
	"THINKING...": "생각 중...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "AI API 키를 `ai config set AI_API_KEY=<your token>`으로 설정하세요.",
	"Set config": "설정",
	"Enter your AI API key": "AI API 키를 입력하세요.",
	"(not set)": "(설정되지 않음)",
	"AI API Key": "AI API 키",
	"Please enter a key": "키를 입력하세요.",
	"AI API Endpoint": "AI API 엔드포인트",
	"Enter your AI API Endpoint": "AI API 엔드포인트를 입력하세요.",
	"Silent Mode": "조용한 모드",
	...
	You: You$8,
	"AI Provider": "AI 제공자",
	"Select your AI Provider": "AI 제공자를 선택하세요"
};
...
var frTranslation = {
	...
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "Veuillez définir votre clé API AI via `ai config set AI_API_KEY=<your token>`",
	"Set config": "Configurer",
	"Enter your AI API key": "Entrez votre clé API AI",
	"(not set)": "(non défini)",
	"AI API Key": "Clé API AI",
	"Please enter a key": "Veuillez entrer une clé",
	"AI API Endpoint": "Point de terminaison de l'API AI",
	"Enter your AI API Endpoint": "Entrez votre point de terminaison d'API AI",
	...
	"Select your AI Provider": "Sélectionnez votre fournisseur d'IA"
};
...
var deTranslation = {
	...
	"THINKING...": "DENKEN...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "Bitte setzen Sie Ihren AI-API-Schlüssel über `ai config set AI_API_KEY=<your token>`",
	"Set config": "Konfiguration setzen",
	"Enter your AI API key": "Geben Sie Ihren AI-API-Schlüssel ein",
	"(not set)": "(nicht gesetzt)",
	"AI API Key": "AI-API-Schlüssel",
	"Please enter a key": "Bitte geben Sie einen Schlüssel ein",
	"AI API Endpoint": "AI-API-Endpunkt",
	"Enter your AI API Endpoint": "Geben Sie Ihren AI-API-Endpunkt ein",
	...
	"Select your AI Provider": "Wählen Sie Ihren AI-Anbieter"
};
...
var ruTranslation = {
	...
	"THINKING...": "ДУМАЮ...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "Пожалуйста, установите свой ключ AI API через `ai config set AI_API_KEY=<your token>`",
	"Set config": "Установить конфигурацию",
	"Enter your AI API key": "Введите ваш ключ AI API",
	"(not set)": "(не установлено)",
	"AI API Key": "Ключ AI API",
	"Please enter a key": "Пожалуйста, введите ключ",
	"AI API Endpoint": "Конечная точка AI API",
	"Enter your AI API Endpoint": "Введите конечную точку AI API",
	...
	"Select your AI Provider": "Выберите поставщика ИИ"
};
...
var ukTranslation = {
	...
	"THINKING...": "ДУМАЮ...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "Будь ласка, встановіть свій ключ AI API через `ai config set AI_API_KEY=<your token>`",
	"Set config": "Встановити конфігурацію",
	"Enter your AI API key": "Введіть свій ключ AI API",
	"(not set)": "(не встановлено)",
	"AI API Key": "Ключ AI API",
	"Please enter a key": "Будь ласка, введіть ключ",
	"AI API Endpoint": "Кінцева точка AI API",
	"Enter your AI API Endpoint": "Введіть кінцеву точку AI API",
	"Silent Mode": "Тихий режим",
	...
	"Select your AI Provider": "Оберіть постачальника ШІ"
};
...
var viTranslation = {
	...
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "Vui lòng thiết lập khóa API AI của bạn thông qua `ai config set AI_API_KEY=<your token>`",
	"Set config": "Cài đặt cấu hình",
	"Enter your AI API key": "Nhập khóa API AI của bạn",
	"(not set)": "(không được đặt)",
	"AI API Key": "Khóa API AI",
	"Please enter a key": "Vui lòng nhập một khóa",
	"AI API Endpoint": "Điểm cuối API AI",
	"Enter your AI API Endpoint": "Nhập Điểm cuối API AI của bạn",
	...
	"Select your AI Provider": "Chọn nhà cung cấp AI của bạn"
};
...
var arTranslation = {
	...
	"THINKING...": "فكر...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "يرجى تعيين مفتاح AI API الخاص بك عبر `ai config set AI_API_KEY=<your token>`",
	"Set config": "تعيين التكوين",
	"Enter your AI API key": "أدخل مفتاح AI API الخاص بك",
	"(not set)": "(غير مضبوط)",
	"AI API Key": "مفتاح AI API",
	"Please enter a key": "الرجاء إدخال مفتاح",
	"AI API Endpoint": "نقطة نهاية AI API",
	"Enter your AI API Endpoint": "أدخل نقطة نهاية AI API الخاصة بك",
	...
	"Select your AI Provider": "اختر مزود الذكاء الاصطناعي الخاص بك"
};
...
var ptTranslation = {
	...
	"THINKING...": "PENSANDO...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "Por favor, defina sua chave de API AI via `ai config set AI_API_KEY=<your token>`",
	"Set config": "Definir configuração",
	"Enter your AI API key": "Insira sua chave de API AI",
	"(not set)": "(não definido)",
	"AI API Key": "Chave de API AI",
	"Please enter a key": "Por favor, insira uma chave",
	"AI API Endpoint": "Endpoint da API AI",
	"Enter your AI API Endpoint": "Insira seu Endpoint da API AI",
	"Silent Mode": "Modo silencioso",
	...
	"Select your AI Provider": "Selecione seu provedor de IA"
};
...
var idTranslation = {
	...
	"THINKING...": "BERPIKIR...",
	"Please set your AI API key via `ai config set AI_API_KEY=<your token>`": "Harap atur kunci API AI Anda melalui `ai config set AI_API_KEY=<token Anda>`",
	"Set config": "Atur konfigurasi",
	"Enter your AI API key": "Masukkan kunci API AI Anda",
	"(not set)": "(belum diatur)",
	"AI API Key": "Kunci API AI",
	"Please enter a key": "Silakan masukkan kunci",
	"AI API Endpoint": "Titik Akhir API AI",
	"Enter your AI API Endpoint": "Masukkan Titik Akhir API AI Anda",
	...
	"Select your AI Provider": "Pilih Penyedia AI Anda"
};
...
var i18n = { setLanguage, t, getCurrentLanguagenName, languages };
...
function getAnthropic(key, apiEndpoint) {
  const client = new Anthropic({
    apiKey: key,
    baseURL: apiEndpoint && apiEndpoint !== "https://api.openai.com/v1" && apiEndpoint !== "https://api.anthropic.com" ? apiEndpoint : void 0
  });
  return client;
}
...
async function generateAnthropicCompletion({
  ...
  try {
    const messages = Array.isArray(prompt) ? prompt.map((msg) => ({ role: msg.role, content: msg.content })) : [{ role: "user", content: prompt }];
...
const readData = (iterableStream, ...excluded) => (writer) => new Promise(async (resolve) => {
  ...
  if (process.stdin.isTTY && typeof process.stdin.setRawMode === "function") {
    ...
    process.stdin.on("keypress", (_, data2) => {
...
async function getModels(key, apiEndpoint, provider = "openai") {
  if (provider === "anthropic") {
    return [
...
const configParsers = {
  AI_API_KEY(key) {
    if (!key) {
      throw new KnownError(
        `Please set your AI API key via \`${commandName} config set AI_API_KEY=<your token>\``
        // TODO: i18n
      );
    }
    return key;
...
const showConfigUI = async () => {
  try {
    ...
    const choice = await p.select({
      ...
      options: [
        ...
        },
        {
          ...
          value: "AI_PROVIDER",
          hint: hasOwn(config, "AI_PROVIDER") ? config.AI_PROVIDER : i18n.t("(not set)")
        },
        {
          label: i18n.t("AI API Endpoint"),
          value: "AI_API_ENDPOINT",
          hint: hasOwn(config, "AI_API_ENDPOINT") ? config.AI_API_ENDPOINT : i18n.t("(not set)")
        },
        {
          label: i18n.t("Silent Mode"),
          value: "SILENT_MODE",
          hint: hasOwn(config, "SILENT_MODE") ? config.SILENT_MODE.toString() : i18n.t("(not set)")
        },
        {
          label: i18n.t("Model"),
          value: "MODEL",
        ...
        },
        {
          ...
          value: "LANGUAGE",
          hint: hasOwn(config, "LANGUAGE") ? config.LANGUAGE : i18n.t("(not set)")
        },
        {
          label: i18n.t("Cancel"),
          value: "cancel",
    ...
    if (choice === "AI_API_KEY") {
      ...
      const { AI_API_KEY: key, AI_API_ENDPOINT: apiEndpoint, AI_PROVIDER: provider } = await getConfig();
...
var update = command(
  ...
  async () => {
    console.log("");
    const command2 = `npm update -g @builder.io/ai-shell`;
    console.log(dim(`${i18n.t("Running")}: ${command2}`));
    console.log("");
...
var chat = command(
  ...
  async () => {
    ...
    const chatHistory = [];
    console.log("");
    console.log(`\u{1F916} Chat Provider: ${provider}, Model: ${model}`);
...
async function prompt({
  ...
  console.log(`\u{1F916} Provider: ${provider}, Model: ${model}`);
...
async function runOrReviseFlow(script, key, model, apiEndpoint, provider, silentMode) {
...
async function revisionFlow(currentScript, key, model, apiEndpoint, provider, silentMode) {
